...
```
go get github.com/liu0x54/timeseriesdatabase-comparisons/cmd/bulk_data_gen github.com/liu0x54/timeseriesdatabase-comparisons/cmd/bulk_load_influx
```
...
```
go get github.com/liu0x54/timeseriesdatabase-comparisons/cmd/bulk_query_gen github.com/liu0x54/timeseriesdatabase-comparisons/cmd/query_benchmarker_influxdb
```
