...
echo    " filtered out 64 hosts with an interval of 1 hour     "
echo    " case 2 takes:                                       "
printf  "       Inf TD              |       %-4.2f s    %-4.2f s \n" $IFQ2 $TDQ2
#printf  "       TDengine           |       %-4.2f Seconds    \n" $TDQ2
echo    "------------------------------------------------------"
echo    " case 3: select the max(value) from random 12 hours"
echo    " data filtered out 64 hosts with an interval of 10 min         "
...
echo    " data filtered out 64 hosts with an interval of 1 min         "
echo    " case 4 takes:                                        "
printf  "       Inf TD              |       %-4.2f s    %-4.2f s \n" $IFQ4 $TDQ4
#printf  "       TDengine           |       %-4.2f Seconds    \n" $TDQ4
echo    "------------------------------------------------------"
