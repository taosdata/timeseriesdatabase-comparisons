...
import (
	...
	"github.com/taosdata/timeseriesdatabase-comparisons/bulk_query_gen/cassandra"
	"github.com/taosdata/timeseriesdatabase-comparisons/bulk_query_gen/elasticsearch"
	"github.com/taosdata/timeseriesdatabase-comparisons/bulk_query_gen/graphite"
	"github.com/taosdata/timeseriesdatabase-comparisons/bulk_query_gen/influxdb"
	"github.com/taosdata/timeseriesdatabase-comparisons/bulk_query_gen/mongodb"
	"github.com/taosdata/timeseriesdatabase-comparisons/bulk_query_gen/opentsdb"
	"github.com/taosdata/timeseriesdatabase-comparisons/bulk_query_gen/splunk"
	"github.com/taosdata/timeseriesdatabase-comparisons/bulk_query_gen/timescaledb"
	"github.com/taosdata/timeseriesdatabase-comparisons/bulk_query_gen/tdengine"
	"log"
	"math/rand"
	"os"
	"sort"
...
var useCaseMatrix = map[string]map[string]map[string]bulkQueryGen.QueryGeneratorMaker{
	common.UseCaseDevOps: {
		...
		DevOpsEightHostsOneHour: {
			...
			"opentsdb-1":         opentsdb.NewOpenTSDBDevops1Hosts,
			"opentsdb-16":         opentsdb.NewOpenTSDBDevops16Hosts,
			"opentsdb-32":         opentsdb.NewOpenTSDBDevops32Hosts,
			"opentsdb-64":         opentsdb.NewOpenTSDBDevops64Hosts,
			"opentsdb-128":         opentsdb.NewOpenTSDBDevops128Hosts,
			"opentsdb-256":         opentsdb.NewOpenTSDBDevops256Hosts,
			"opentsdb-512":         opentsdb.NewOpenTSDBDevops512Hosts,
			"opentsdb-2h":         opentsdb.NewOpenTSDBDevops8Hosts2Hr,
			"opentsdb-4h":         opentsdb.NewOpenTSDBDevops8Hosts4Hr,
			"opentsdb-8h":         opentsdb.NewOpenTSDBDevops8Hosts8Hr,
			"opentsdb-12h":         opentsdb.NewOpenTSDBDevops8Hosts12Hr,
			"opentsdb-mixfunc":         opentsdb.NewOpenTSDBDevops8HostsMixfunc,
		...
		DevOpsEightHostsTwelveHours:{
			...
			"opentsdb":		opentsdb.NewOpenTSDBDevops8Hosts12Hour10m,
			"opentsdb-1":		opentsdb.NewOpenTSDBDevops1Hosts12Hour10m,
			"opentsdb-16":		opentsdb.NewOpenTSDBDevops16Hosts12Hour10m,
			"opentsdb-32":		opentsdb.NewOpenTSDBDevops32Hosts12Hour10m,
			"opentsdb-64":		opentsdb.NewOpenTSDBDevops64Hosts12Hour10m,
			"opentsdb-128":		opentsdb.NewOpenTSDBDevops128Hosts12Hour10m,
			"opentsdb-256":		opentsdb.NewOpenTSDBDevops256Hosts12Hour10m,
			"opentsdb-512":		opentsdb.NewOpenTSDBDevops512Hosts12Hour10m,
		...
		DevOpsEightHostsAllbyHours:{
			...
			"opentsdb":		opentsdb.NewOpenTSDBDevops8HostsAllBy1Hr,
			"opentsdb-1":		opentsdb.NewOpenTSDBDevops1HostsAllBy1Hr,
			"opentsdb-16":		opentsdb.NewOpenTSDBDevops16HostsAllBy1Hr,
			"opentsdb-32":		opentsdb.NewOpenTSDBDevops32HostsAllBy1Hr,
			"opentsdb-64":		opentsdb.NewOpenTSDBDevops64HostsAllBy1Hr,
			"opentsdb-128":		opentsdb.NewOpenTSDBDevops128HostsAllBy1Hr,
			"opentsdb-256":		opentsdb.NewOpenTSDBDevops256HostsAllBy1Hr,
			"opentsdb-512":		opentsdb.NewOpenTSDBDevops512HostsAllBy1Hr,
		...
		DevOpsEightHostsAll:{
			...
			"opentsdb":		opentsdb.NewOpenTSDBDevops8HostsAll,
			"opentsdb-1":		opentsdb.NewOpenTSDBDevops1HostsAll,
			"opentsdb-16":		opentsdb.NewOpenTSDBDevops16HostsAll,
			"opentsdb-32":		opentsdb.NewOpenTSDBDevops32HostsAll,
			"opentsdb-64":		opentsdb.NewOpenTSDBDevops64HostsAll,
			"opentsdb-128":		opentsdb.NewOpenTSDBDevops128HostsAll,
			"opentsdb-256":		opentsdb.NewOpenTSDBDevops256HostsAll,
			"opentsdb-512":		opentsdb.NewOpenTSDBDevops512HostsAll,
